...
4. Write a program to find largest of 3 numbers using 4 functions using Pass by value
int input()
int cmp(int a, int b, int c)
void output(int a, int b, int c, int largest)


5. Write a program to find largest of 3 numbers using 4 functions using pass by reference
